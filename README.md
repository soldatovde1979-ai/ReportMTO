...
3. `docs\data.md` — описание данных: источники, форматы, поля, контракт промпта и шаблона
   (ревизия 16.09.2026, §3.3 — все 78 плейсхолдеров). Парный `docs\spec.md` — спецификация системы.
...
| `src\vba\modContentZone.bas` | Слайд 1 и слайды 5–8 («Техника»): 47 плейсхолдеров, примитивы разметки и графики | **Content Spec** |
...
| `tmp_index.html` | Рабочий HTML-шаблон v4.6: плейсхолдеры и навигация по 8 слайдам | **Content Spec** |
| `examples\reference-example.html` | Визуальный референс для сверки стиля (НЕ рабочий шаблон) | — |
| `docs\spec.md`, `docs\data.md` | Спецификация системы и данные: поля выгрузки, нормализация, контракт `tbDATA`, промпт, 78 плейсхолдеров шаблона | — |
