...
| `install\VERSION`, `install\release.state` | Версия сборки (первая строка) и состояние прошлого релиза (служебный) | — |
| `install\migrations\*.ps1` | Доп. код версии: то, что нужно доделать в книге сверх установки кода | — |
| `CHANGELOG.md` | Накопительный журнал версий, ведёт `release.ps1` | — |
