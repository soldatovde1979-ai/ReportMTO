# ЗАМЕНЁН 11.09.2026 на миграцию install\migrations\8.1.0__variable_keys.ps1,
# которую прогоняет install\release.ps1. Оставлен в архиве. В работе не использовать.
