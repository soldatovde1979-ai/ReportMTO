...
> строка `AI/API_KEY` в новых настройках не заполняется. Настройка — `docs/install/install-v7.1.md`.
...
**Системное сообщение (дословно; обновляется постановкой `task-for-coder.md` v1.1 — 7 слайдов):**
```
...
> v1.1 постановки (`docs/task-for-coder.md`): **сигнатура контракта не меняется**. Расширение с 3 до
...
- ⚠️ **Построчный дамп `tbDATA` с ФИО за 2 недели встроен в автономный HTML-отчёт** (решение
  заказчика от 07.09.2026, «Презентация и блоки данных» §1.1): копия файла отчёта теперь несёт
...
[`docs/task-for-coder.md`](docs/task-for-coder.md:1): контракт запроса/ответа ИИ расширен до 7
